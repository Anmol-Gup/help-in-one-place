    ...
    { ?>
        ...
        <form action="./volunteer.php" method="post" style="margin: 1.5rem 0;" enctype="multipart/form-data">
            <div class="registration">
                <h1>Volunteer Registration Details</h1>
                <br>
                ...
                <input type="date" name="vol_dob" min="1950-01-01" max="2003-03-24">  
            </div>
            ...
            <div class="occupations-details">
                ...
                <select id="volunteer_occu" name="vol_occ" required>
                    ...
                    <option value="en">Entrepreneur</option>
                    <option value="sw">Social Worker</option>
                    <option value="de">Service Person</option>
