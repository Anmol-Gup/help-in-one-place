...
<body>
    ...
    <br/>
    <div class="terms">
        <h1>Overview</h1><hr/><br/>
        <div class="content">
            <p>
                The website and the solutions are operated and managed by separate entities. Refsnes Data offers the website including all its content, information, and related tools. The solutions (Such as Spaces, Courses, and My learning) and billing system are operated by Help in One Place Network. The two entities are separately responsible for the services that they provide, manage and operate.
                Throughout the site, the terms "we", "us" and "our" refer to Refsnes Data.
